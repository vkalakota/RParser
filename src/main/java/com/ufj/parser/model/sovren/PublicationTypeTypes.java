...
/**
 * <p>Java class for PublicationTypeTypes.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="PublicationTypeTypes"&gt;
...
public enum PublicationTypeTypes {
    ...
    public static PublicationTypeTypes fromValue(String v) {
        for (PublicationTypeTypes c: PublicationTypeTypes.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
