...
public class UFJResume {
    ...
    public void setNumberofJobChanged(String numberofJobChanged) {
        this.numberofJobChanged = numberofJobChanged;
    }
    ...
    public String getC_references() {
        return c_references;
    }

    public void setC_references(String c_references) {
        this.c_references = c_references;
    }
    ...
    public void setBehaviorSkills(String behaviorSkills) {
        this.behaviorSkills = behaviorSkills;
    }
    ...
    public void setFormattedPhoneNo(String formattedPhoneNo) {
    ...
    public void setFormattedMobileNo(String formattedMobileNo) {
        this.formattedMobileNo = formattedMobileNo;
    }
    ...
    public void setSocialVerificationScore(String socialVerificationScore) {
        this.socialVerificationScore = socialVerificationScore;
    }
